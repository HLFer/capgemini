    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="links">
                    <a href="https://www.capgemini.com/" target="_blank">Site Oficial</a>
                    <a href="https://henriquefernandes.info" target="_blank">Site do Desenvolvedor</a>
                    <a href="https://github.com/HLFer/capgemini" target="_blank">Projeto no GitHub</a>
                </div>
            </div>
        </div>
    
        <div class="" id="footer">
            Teste de Sistema Desenvolvido por: Henrique L. Fernandes
        </div>
    </body>
</html>
